...
import com.fag.lucasmartins.arquitetura_software.infrastructure.adapters.in.messaging.pedido.exceptions.ConsumerSQSException;
...
public class SqsPedidoAdapter {
    ...
    public void receberMensagem(PedidoEventDTO evento) {
        try {
            log.info("Pedido recebido do SQS: customerId={} origin={} occurredAt={}", evento.getCustomerId(), evento.getOrigin(), evento.getOccurredAt());
            ...
            log.error("Erro ao processar o pedido para o cliente {}", evento.getCustomerId(), e);
            throw new ConsumerSQSException("Erro ao processar o pedido para o cliente " + evento.getCustomerId(), e);
        }
    }
}
